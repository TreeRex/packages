...
(task-options!
 pom {:project     'cljsjs/sigma
      :version     +version+
      :description "Sigma is a JavaScript library dedicated to graph drawing"
...
(deftask package []
  (comp
   (download :url (format "https://github.com/jacomyal/sigma.js/releases/download/v%s/release-v%s.zip"
             ...
             :unzip     true)
   (sift :move {#"^build/sigma\.js"      "cljsjs/sigma/development/sigma.inc.js"
                #"^build/sigma\.min\.js" "cljsjs/sigma/production/sigma.min.inc.js"})
   (sift :include #{#"^cljsjs"})
